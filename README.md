# GoPaint
## A second-level headingGoPaint! A pure Java Swing based drawing application made by Mohamed Amine Khazroun
...
### A second-level headingHere is the main interface (can also be called a Canvas) which gathers all the the features the app provide:
